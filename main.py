...
if __name__ == '__main__':
    ...
    processors['pretrain_mocotuning'] = import_class('processor.pretrain_mocotuning.MOCOTuningProcessor')
    processors['pretrain_dinotuning'] = import_class('processor.pretrain_dinotuning.DINOTuningProcessor')
    processors['pretrain_clrtuning'] = import_class('processor.pretrain_clrtuning.CLRTuningProcessor')
    ...
    p = Processor(sys_argv, int(os.environ["LOCAL_RANK"]))
